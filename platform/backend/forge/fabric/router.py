    ...
    "retail": {
        ...
        "intents": {
            ...
            "total_sales": {"keywords": ["total", "how much", "sales", "revenue"],
                "sql": "SELECT SUM(amount) AS total_sales, COUNT(*) AS orders "
    ...
    "finance": {
        ...
        "intents": {
            "revenue_by_region": {"keywords": ["region", "geography", "geographic", "market"],
                "sql": "SELECT region, SUM(amount) AS revenue FROM revenue "
                       "GROUP BY region ORDER BY revenue DESC"},
            "revenue_by_month": {"keywords": ["month", "monthly", "trend", "over time", "quarter"],
                "sql": "SELECT month, SUM(amount) AS revenue FROM revenue "
                       "GROUP BY month ORDER BY month"},
            "top_expenses": {"keywords": ["expense", "expenses", "cost", "spend", "spending"],
                "sql": "SELECT category, SUM(amount) AS spend FROM expenses "
            ...
            "total_revenue": {"keywords": ["revenue", "total", "income", "how much"],
                "sql": "SELECT SUM(amount) AS total_revenue, COUNT(DISTINCT month) AS months "
                       "FROM revenue"},
        },
    },
    "banking": {
        ...
        "intents": {
            ...
            "loans_outstanding": {"keywords": ["loan", "loans", "outstanding", "principal", "delinquent"],
                "sql": "SELECT status, COUNT(*) AS loans, SUM(principal) AS principal "
            ...
            "deposits_by_type": {"keywords": ["deposit", "balance", "account", "savings", "checking", "total"],
                "sql": "SELECT type, COUNT(*) AS accounts, SUM(balance) AS total_balance "
